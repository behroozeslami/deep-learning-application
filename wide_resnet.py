...
class BasicBlock(nn.Module):
    ...
    def __init__(self,in_channels, out_channels):
        ...
        self.main_path = nn.Sequential(cnn1, bn1, self.relu, cnn2, bn2)
        ...
        if down_sample:
            ...
            self.shortcut = nn.Sequential(cnn3, bn3)
        else:
...
class WideResnet(nn.Module):
    ...
    def __init__(self, architecture, block_class):
        ...
        relu = nn.ReLU()
        bn = nn.BatchNorm2d(architecture['out_cnn'])
        ...
        mudules = [cnn, bn, relu] + blocks + [pool, flatten, fc]
    ...
    def make_extended_blocks(self, block_class, architecture):
        ...
        for extended_block in architecture['blocks']:
            ...
            for n in range(block_size):
                block = block_class(in_block, out_block)
                blocks.append(block)
                in_block = out_block
        return blocks
